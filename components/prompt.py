...
5. If any API output contains S3 URI, you must always return it in your final response within the xml tags <generated_s3_uri>output_s3_uri</generated_s3_uri>
</Instructions>"""
